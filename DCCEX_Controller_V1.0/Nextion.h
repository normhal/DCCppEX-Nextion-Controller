...
#if defined (ARDUINO_AVR_UNO)|| defined (ESP8266)   //nkh These 3 lines were added to allow 
	#define USE_SOFTWARE_SERIAL                       //nkh "seamless" switching between
#endif                                              //nkh Hardware and Software Serial
...
class Nextion{
 ...
 public:
  ...
  boolean setNextionValue(String component, int value);     //nkh

  boolean ack(void);//Deprecated

  unsigned int getComponentValue(String component);
  unsigned int getNextionValue(String component);           //nkh
