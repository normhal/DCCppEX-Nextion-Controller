...
*  for the "Extentions to Dave Bodnar's Nextion Throttle", everything in this version represents my first 
*  venture into the world of "C" and a little "C++". Any critique of my code and design style is both expected
*  and appreciated:-)
*  I would especially welcome suggestions, ideas, and ways to do things "better", so please be free to forward any
*  thoughts or comments you may feel are useful.
*  
*  History
*  
...
*  This "Final" version represents the result of 8 months of fun. 
*  
...
*  The evolution of my original goal resulted in a device with the capabilities and support as summarized below.
*  
...
*  - "Routes" - basic setting of up to 6 accessories per route - 6 Routes for UNOs, up to 48 for ESPs
*  
...
*    needed. The Nextion uses two slightly modified files from the "Bently Born Nextion Library"
*    This library has been chosen for two main reasons:
*    1. It's very easy to use:-)
*    2. It uses Nextion Object Names instead of Object IDs. This makes HMI design and maintenance much simpler IMHO
*    I have enabled a timing feature included in the Library and therefore include the modified
*    Library files with the Sketch. In addition, I have expanded the support to read the Nextion "TCH0" variable.
*  
*  How To's
*  
...
*     - If Enabled during compilation it is possible to use "Hard-Coded" Locos and Accessories
...
*           defined in "Config.h" for subsequent editing. Default is 10 Locos.
*         - In addition a page of Accessories and two very simple "Routes" can be loaded
*      or
*     -  Select the "Roster" page, highlight one of the "Slots" by touching it, then press the "Edit" button
...
{
  PowerState = 1;
  myNextion.setComponentValue("Power", 1);
  sendCMD("<1>");
}
/*
 *************************************************************************************************************************
...
{
  PowerState = 0;
  myNextion.setComponentValue("Power", 0);
  sendCMD("<0>");
}
/*
 *************************************************************************************************************************
