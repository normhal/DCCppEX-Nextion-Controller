...
//      newLocoAddress = readLocoAddress(editingID);
//      newLocoRoadNumber = readLocoRNum(editingID);
      #if defined ESP
...
//      nextionSetText("ID", String(editingID));
    ...
    //****************************************************************************************************************************** 
      ...
      case AccEditPage: 
      {
        #if !defined SAVE_MEMORY || !defined NO_ACCESSORIES
    ...
    case FunctionEditPage:
    {
      ...
      uint8_t funcImage = readEEPROMByte((locoFuncBase + (editingID * 20)) + ((g_fSlot*2)+1));                      //Retrieve Image Number
    ...
    {
      #if defined NO_ACCESSORIES
        nextionCommand(("b2.pic=" + String(BLANK_BUTTON)).c_str());
        nextionCommand(("b2.pic2=" + String(BLANK_BUTTON)).c_str());
        nextionCommand(("b3.pic=" + String(BLANK_BUTTON)).c_str());
        nextionCommand(("b3.pic2=" + String(BLANK_BUTTON)).c_str());
      #endif
      #if defined NO_PROGRAMMING
        nextionCommand(("b4.pic=" + String(BLANK_BUTTON)).c_str());
        nextionCommand(("b4.pic=2" + String(BLANK_BUTTON)).c_str());
      #endif
      #if defined NO_WIFI
        nextionCommand(("b7.pic=" + String(BLANK_BUTTON)).c_str());
        nextionCommand(("b7.pic2=" + String(BLANK_BUTTON)).c_str());
      #endif
    }
  }
}
