...
Nextion Display to Second Serial Port (UART1)
Hardware Serial RX - Pico pin GPIO9 to Nextion TX wire (Blue)
Hardware Serial TX - Pico pin GPIO8 to Nextion RX wire (Yellow)

Connection to Command Station to First Serial Port (UART0 )(for debug Console or if using Direct Connection to Command Station)
