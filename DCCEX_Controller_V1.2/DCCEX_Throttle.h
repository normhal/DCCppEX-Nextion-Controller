...
*/
  ...
  //**************************************************************************************
    ...
    #define buttonPin 8      // the Arduino Pin number for the encoder reverse button
 
    #if defined RE_POLLED
      #define pinA 7         
      #define pinB 6          
    #elif defined RE_INTERRUPTS
...
typedef struct locomotive loco;
  ...
  uint8_t functions[numLocos][numFSlots];    //Array of function slots and the state of the function which occupies that slot
...
//Revised Text acquisition from Nextion
//uint16_t newLocoAddress = 0;
//String newLocoRoadName;
//uint16_t newLocoRoadNumber = 0;
//String newLocoType;

//uint16_t newAccAddress = 0;
//uint8_t newAccImage = BLANK;
//String newAccName;
